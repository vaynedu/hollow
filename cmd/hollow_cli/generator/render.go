...
func projectFiles(config ProjectConfig) []projectFile {
	return []projectFile{
		...
		{path: "config/config_test.go", template: "config_test.go.tmpl"},
		{path: "control/control.go", template: "control.go.tmpl"},
		{path: "control/health.go", template: "control_health.go.tmpl"},
		{path: "control/health_test.go", template: "control_health_test.go.tmpl"},
		{path: "dao/dao.go", template: "dao.go.tmpl"},
		{path: "database/database.go", template: "database.go.tmpl"},
		...
		{path: "service/health_test.go", template: "service_health_test.go.tmpl"},
